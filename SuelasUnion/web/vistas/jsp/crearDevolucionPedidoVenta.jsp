                    ...
                    <div class="main-content">
                        ...
                        <div class="section__content section__content--p30">
                            <div class="container-fluid">
                                ...
                                <form action="../../ControladorDevolucionPedidoVenta"  method="GET">
                                    ...
                                    <select name="opciones" class="form-control">
                                        <%
                                            List<PedidoDeVenta> list = (List<PedidoDeVenta>) request.getSession().getAttribute("pedidos");
                                            for (PedidoDeVenta dto : list) {
                                        %>
                                    ...
                                    <br>
                                    <a class="btn btn-primary" href="../../ControladorDevolucionPedidoVenta?accion=listar">Atras</a>
