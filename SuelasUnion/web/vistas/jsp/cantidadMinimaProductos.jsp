                ...
                <div class="main-content">
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            <!-- EMPIEZA Departamento -->
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h1 class="title-1">Departamento:</h1> 
                                </div>
                            </div> 
                            <div class="row form-group" style="margin-top: 30px;">
                                <div class="col-12 col-md-9">
                                    <select name="select" id="select" class="form-control">
                                        <option value="1">Salpas</option>
                            ...
                            <div class="col-lg-6" style="margin-top: 35px;">
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon">Cantidad mínima</div>
                                        <input value="cantidad_min_requeridaa" type="number" id="username3" name="username3" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="row form-group">
                                    <button type="submit" class="btn btn-primary" style="margin-left: 565px;">Confirmar</button>
                                </div>
                            </div>
                            <!-- END PAGE CONTAINER-->
