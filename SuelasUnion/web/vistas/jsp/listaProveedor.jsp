                                ...
                                <div class="table-responsive table-responsive-data2">
                                    ...
                                    <div class="row">
                                        <div class="col col-sm-3">
                                            <span class="la bel label-default">Buscar</span>
                                        ...
                                        <div class="col col-sm-3">
                                            ...
                                            <a class="btn btn-success" href="../../Proveedor?accion=formcreate"  style="margin-top: 25px;">Agregar Proveedor</a>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive m-b-40">
                                        <table class="table table-borderless table-data3">
                                            ...
                                            <%
                                                System.out.println(request.getSession().getAttribute("listaProveedor").toString());
                                                List<Proveedor> list = (List<Proveedor>) request.getSession().getAttribute("listaProveedor");

                                                for (Proveedor dto : list) {
                                            %>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><%=dto.getEmpresa()%></td>
                                                    <td class="text-center"><%=dto.getTelefono()%></td>                               
                                                    <td class="text-center"><%=dto.getCorreo()%></td>
                                                    <td class="text-center"><%=dto.getDireccion()%></td>
                                                    <td class="text-center">
                                                        <a class="btn btn-warning" href="../../Proveedor?accion=formupdate&cedula=<%= dto.getCedula()%>" style="margin-bottom: 10px; width: 90px">Editar</a>
                                                        <a class="btn btn-danger"  href="../../Proveedor?accion=delete&cedula=<%= dto.getCedula()%>">Eliminar</a>
                                                    </td>
                                                </tr>
                                                <%}%>
                                            </tbody>
