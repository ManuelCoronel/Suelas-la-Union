        ...
        <div class="page-wrapper">
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="section__content section__content--p30"><h1 style="margin-left: 20px;margin-bottom: 50px;">Suelas Expanso</h1>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive table-responsive-data2">
                                            <div class="row">
                                             ...
                                             <div class="col col-sm-3">
                                                    <input hidden="true" name="tipo" value="3" type="text" class="form-control">
                                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><%=elem.getTalla()%></td>
                                                     <td class="text-center"><%=elem.getProducto().getCantidadDisponible() %></td>
                                                          <td><%=elem.getProducto().getPrecio() %></td>
