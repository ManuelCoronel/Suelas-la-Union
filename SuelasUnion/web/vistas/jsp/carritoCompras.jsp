                        ...
                        <div class="col-8">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <%
                                            if ((List<Producto>) request.getSession().getAttribute("productosCarrito") != null) {
                                                List<Producto> lisPro = (List<Producto>) request.getSession().getAttribute("productosCarrito");
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>-</td>
                                            <td><%=pro.getPrecio()%></td>
                                            <td><%=cantidadesCarrito.get(j++)%></td>
                                            <td><%=pro.getPrecio() * cantidadesCarrito.get(j - 1)%></td>
                                            <td> <a href="../../ControladorCarritoCompras?accion=eliminar&id=<%=pro.getId()%>"><button type="button" class="btn btn-danger">Eliminar</button></a></td>
                                        </tr>
                                        <%
                        ...
                        <div class="col-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <input class="form-control" type="text" value="$ <%=(request.getSession().getAttribute("subTotalCarrito") != null) ? request.getSession().getAttribute("subTotalCarrito") : 0%>" disabled></br>
                                    <label>Descuento:</label>
                                    <input class="form-control" type="text" value="$ 0" disabled></br>
                                    <label>Total Pagar:</label>
                                    <input class="form-control" type="text" value="$ <%=(request.getSession().getAttribute("subTotalCarrito") != null) ? request.getSession().getAttribute("subTotalCarrito") : 0%>" disabled></br>
                                </div>
                                <div class="card-footer">
                                    <% if (user != null) {%>
                                    <a class="btn btn-primary btn-block" href="../../ControladorGenerarPedido?accion=generarPedido">Hacer Pedido</a>
                                    <%} else {%>
                                    <a class="btn btn-primary btn-block" href="loginCliente.jsp">Hacer Pedido</a>
                                    <%}%>
                                    <a class="btn btn-primary btn-block" href="../../loginCliente?accion=catalogo">Seguir Comprando</a>
                                </div>
                            </div>
                        </div>
                    </div>
