                                    ...
                                    <div class="row form-group" style="margin-left: 1px;">
                                        <div class="col-md-12">
                                            <div class="overview-wrap">
                                                <h2 class="title-1 mb-3">Producto</h2>
                                            </div>
                                        </div>

                                        <form class="col-md-10" action="../../ControladorPedidoVen" method="POST">
                                            <div class="row form-group">
                                                <div class="col col-md-12">

                                                    <select name="productoTomado" class="form-control form-control-lg">
                                            ...
                                            <div class="row d-flex justify-content-center" >
                                                <button type="submit"  class="btn btn-primary w-25"  name="accion" value="AgregarProductoVenta" >Agregar producto</button>
                                            </div>
                                        ...
                                        <%        
                                            if(request.getSession().getAttribute("listaPPVActual")!=null){
                                        %>
                                               <div class="row offset-2 justify-content" >
                                            <jsp:include page="productosVentaActual.jsp" flush="true"/>
                                                </div>
                                            <%
                                            }
                                            %>
