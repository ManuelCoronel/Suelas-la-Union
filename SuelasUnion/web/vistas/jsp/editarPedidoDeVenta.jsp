                                    ...
                                    <div class="row form-group" style="margin-left: 1px;">
                                        ...
                                        <form class="col-md-5" action="../../ControladorPedidoVen" method="GET">
                                            ...
                                            <%
                                                ...
                                                DTO.PedidoDeVenta pedidoEditar = (DTO.PedidoDeVenta) request.getSession().getAttribute("pedidoEditar");

                                            %>

                                            <h2 class="title-2 mb-3">Cedula del cliente</h2> 
                                            <input class="form-control" type="rext" name="cedula" value="<%=pedidoEditar.getClienteCedula().getCedula()%>" required>


                                            <br>      <br> 
                                            <h2 class="title-2 mb-3">Fecha de la orden</h2>
                                            <input class="form-control" type="date" name="fechaOrden" value="<%=pedidoEditar.getFechaOrden()%>" required>


                                            <br>      <br>
                                            <h2 class="title-2 mb-3">Fecha de entrega de la factura </h2> 
                                            <input class="form-control" type="date" name="fechaFactura" value="<%=pedidoEditar.getFechaEntregaFactura()%>" required>

                                            <br>      <br>
                                            <h2 class="title-2 mb-3">Fecha de plazo de pago </h2> 
                                            <input class="form-control" type="date" name="fechaPlazo" value="<%=pedidoEditar.getFechaPlazo()%>"  required>
                                            <br>      <br>
                                            <h2 class="title-2 mb-3">Entrega :</h2> 
                                            ...
                                            <br>      <br>
                                            <h2 class="title-2 mb-3">Estado :</h2> 
                                            ...
                                            <div class="row d-flex justify-content-center" >
                                                <button type="submit"  class="btn btn-primary w-25"  name="accion" value="EditarPedidoVenta" >Editar</button>
                                            </div>
                                        </form>
                                    </div>
                                </div> <!-- aca termina -->
