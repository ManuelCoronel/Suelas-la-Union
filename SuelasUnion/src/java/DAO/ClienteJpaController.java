...
public class ClienteJpaController implements Serializable {
    ...
    public void create(Cliente cliente) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (PedidoDeVenta pedidoDeVentaListPedidoDeVentaToAttach : cliente.getPedidoDeVentaList()) {
                pedidoDeVentaListPedidoDeVentaToAttach = em.getReference(pedidoDeVentaListPedidoDeVentaToAttach.getClass(), pedidoDeVentaListPedidoDeVentaToAttach.getId());
    ...
    public void edit(Cliente cliente) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (PedidoDeVenta pedidoDeVentaListNewPedidoDeVentaToAttach : pedidoDeVentaListNew) {
                pedidoDeVentaListNewPedidoDeVentaToAttach = em.getReference(pedidoDeVentaListNewPedidoDeVentaToAttach.getClass(), pedidoDeVentaListNewPedidoDeVentaToAttach.getId());
    ...
    public List<Cliente> findClienteEntities() { //trae todos los registros, es una clase que implementa JPA
