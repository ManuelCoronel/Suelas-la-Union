...
public class DevolucionClienteJpaController implements Serializable {
    ...
    public DevolucionClienteJpaController() {
        this.emf = con.getBd();
    }
    ...
    public void create(DevolucionCliente devolucionCliente) {
        ...
        try {
            ...
            if (pedidoDeVentaIdPedidoDeVenta != null) {
                pedidoDeVentaIdPedidoDeVenta = em.getReference(pedidoDeVentaIdPedidoDeVenta.getClass(), pedidoDeVentaIdPedidoDeVenta.getId());
    ...
    public void edit(DevolucionCliente devolucionCliente) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (pedidoDeVentaIdPedidoDeVentaNew != null) {
                pedidoDeVentaIdPedidoDeVentaNew = em.getReference(pedidoDeVentaIdPedidoDeVentaNew.getClass(), pedidoDeVentaIdPedidoDeVentaNew.getId());
