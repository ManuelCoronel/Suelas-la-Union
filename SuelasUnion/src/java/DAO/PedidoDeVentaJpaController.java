...
public class PedidoDeVentaJpaController implements Serializable {
  Conexion con = Conexion.getConexion();
    public PedidoDeVentaJpaController() {
        this.emf = con.getBd();
    }
    ...
    public void create(PedidoDeVenta pedidoDeVenta) {
        ...
        try {
            ...
            for (ProductoPedidoVenta productoPedidoVentaListProductoPedidoVenta : pedidoDeVenta.getProductoPedidoVentaList()) {
                PedidoDeVenta oldPedidoDeVentaOfProductoPedidoVentaListProductoPedidoVenta = productoPedidoVentaListProductoPedidoVenta.getPedidoDeVenta();
                productoPedidoVentaListProductoPedidoVenta.setPedidoDeVenta(pedidoDeVenta);
                productoPedidoVentaListProductoPedidoVenta = em.merge(productoPedidoVentaListProductoPedidoVenta);
                if (oldPedidoDeVentaOfProductoPedidoVentaListProductoPedidoVenta != null) {
                    oldPedidoDeVentaOfProductoPedidoVentaListProductoPedidoVenta.getProductoPedidoVentaList().remove(productoPedidoVentaListProductoPedidoVenta);
                    oldPedidoDeVentaOfProductoPedidoVentaListProductoPedidoVenta = em.merge(oldPedidoDeVentaOfProductoPedidoVentaListProductoPedidoVenta);
                }
            }
    ...
    public void edit(PedidoDeVenta pedidoDeVenta) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            PedidoDeVenta persistentPedidoDeVenta = em.find(PedidoDeVenta.class, pedidoDeVenta.getId());
            ...
            for (ProductoPedidoVenta productoPedidoVentaListOldProductoPedidoVenta : productoPedidoVentaListOld) {
                if (!productoPedidoVentaListNew.contains(productoPedidoVentaListOldProductoPedidoVenta)) {
                    ...
                    illegalOrphanMessages.add("You must retain ProductoPedidoVenta " + productoPedidoVentaListOldProductoPedidoVenta + " since its pedidoDeVenta field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (ProductoPedidoVenta productoPedidoVentaListNewProductoPedidoVenta : productoPedidoVentaListNew) {
                if (!productoPedidoVentaListOld.contains(productoPedidoVentaListNewProductoPedidoVenta)) {
                    PedidoDeVenta oldPedidoDeVentaOfProductoPedidoVentaListNewProductoPedidoVenta = productoPedidoVentaListNewProductoPedidoVenta.getPedidoDeVenta();
                    productoPedidoVentaListNewProductoPedidoVenta.setPedidoDeVenta(pedidoDeVenta);
                    productoPedidoVentaListNewProductoPedidoVenta = em.merge(productoPedidoVentaListNewProductoPedidoVenta);
                    if (oldPedidoDeVentaOfProductoPedidoVentaListNewProductoPedidoVenta != null && !oldPedidoDeVentaOfProductoPedidoVentaListNewProductoPedidoVenta.equals(pedidoDeVenta)) {
                        oldPedidoDeVentaOfProductoPedidoVentaListNewProductoPedidoVenta.getProductoPedidoVentaList().remove(productoPedidoVentaListNewProductoPedidoVenta);
                        oldPedidoDeVentaOfProductoPedidoVentaListNewProductoPedidoVenta = em.merge(oldPedidoDeVentaOfProductoPedidoVentaListNewProductoPedidoVenta);
                    }
                }
            }
            em.getTransaction().commit();
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = pedidoDeVenta.getId();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (ProductoPedidoVenta productoPedidoVentaListOrphanCheckProductoPedidoVenta : productoPedidoVentaListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This PedidoDeVenta (" + pedidoDeVenta + ") cannot be destroyed since the ProductoPedidoVenta " + productoPedidoVentaListOrphanCheckProductoPedidoVenta + " in its productoPedidoVentaList field has a non-nullable pedidoDeVenta field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
