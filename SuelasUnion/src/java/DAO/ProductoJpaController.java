...
import DTO.DevolucionProveedorProducto;
  ...
  Conexion con = Conexion.getConexion();
    ...
    public void create(Producto producto) {
        ...
        try {
            ...
            for (ProductoPedidoVenta productoPedidoVentaListProductoPedidoVentaToAttach : producto.getProductoPedidoVentaList()) {
                productoPedidoVentaListProductoPedidoVentaToAttach = em.getReference(productoPedidoVentaListProductoPedidoVentaToAttach.getClass(), productoPedidoVentaListProductoPedidoVentaToAttach.getProductoPedidoVentaPK());
            ...
            em.persist(producto);
            if (proveedorCedula != null) {
                proveedorCedula.getProductoList().add(producto);
            ...
            for (ProductoPedidoVenta productoPedidoVentaListProductoPedidoVenta : producto.getProductoPedidoVentaList()) {
                Producto oldProductoOfProductoPedidoVentaListProductoPedidoVenta = productoPedidoVentaListProductoPedidoVenta.getProducto();
                productoPedidoVentaListProductoPedidoVenta.setProducto(producto);
                productoPedidoVentaListProductoPedidoVenta = em.merge(productoPedidoVentaListProductoPedidoVenta);
                if (oldProductoOfProductoPedidoVentaListProductoPedidoVenta != null) {
                    oldProductoOfProductoPedidoVentaListProductoPedidoVenta.getProductoPedidoVentaList().remove(productoPedidoVentaListProductoPedidoVenta);
                    oldProductoOfProductoPedidoVentaListProductoPedidoVenta = em.merge(oldProductoOfProductoPedidoVentaListProductoPedidoVenta);
                }
            }
    ...
    public void edit(Producto producto) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            Proveedor proveedorCedulaOld = persistentProducto.getProveedorCedula();
            Proveedor proveedorCedulaNew = producto.getProveedorCedula();
            ...
            for (ProductoPedidoVenta productoPedidoVentaListOldProductoPedidoVenta : productoPedidoVentaListOld) {
                if (!productoPedidoVentaListNew.contains(productoPedidoVentaListOldProductoPedidoVenta)) {
                    ...
                    illegalOrphanMessages.add("You must retain ProductoPedidoVenta " + productoPedidoVentaListOldProductoPedidoVenta + " since its producto field is not nullable.");
                }
            }
            ...
            if (proveedorCedulaNew != null) {
                ...
                producto.setProveedorCedula(proveedorCedulaNew);
            }
            if (salpaNew != null) {
            ...
            for (ProductoPedidoVenta productoPedidoVentaListNewProductoPedidoVentaToAttach : productoPedidoVentaListNew) {
                productoPedidoVentaListNewProductoPedidoVentaToAttach = em.getReference(productoPedidoVentaListNewProductoPedidoVentaToAttach.getClass(), productoPedidoVentaListNewProductoPedidoVentaToAttach.getProductoPedidoVentaPK());
            ...
            for (ProductoPedidoVenta productoPedidoVentaListNewProductoPedidoVenta : productoPedidoVentaListNew) {
                if (!productoPedidoVentaListOld.contains(productoPedidoVentaListNewProductoPedidoVenta)) {
                    Producto oldProductoOfProductoPedidoVentaListNewProductoPedidoVenta = productoPedidoVentaListNewProductoPedidoVenta.getProducto();
                    productoPedidoVentaListNewProductoPedidoVenta.setProducto(producto);
                    productoPedidoVentaListNewProductoPedidoVenta = em.merge(productoPedidoVentaListNewProductoPedidoVenta);
                    if (oldProductoOfProductoPedidoVentaListNewProductoPedidoVenta != null && !oldProductoOfProductoPedidoVentaListNewProductoPedidoVenta.equals(producto)) {
                        oldProductoOfProductoPedidoVentaListNewProductoPedidoVenta.getProductoPedidoVentaList().remove(productoPedidoVentaListNewProductoPedidoVenta);
                        oldProductoOfProductoPedidoVentaListNewProductoPedidoVenta = em.merge(oldProductoOfProductoPedidoVentaListNewProductoPedidoVenta);
                    }
                }
            }
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (ProductoPedidoVenta productoPedidoVentaListOrphanCheckProductoPedidoVenta : productoPedidoVentaListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Producto (" + producto + ") cannot be destroyed since the ProductoPedidoVenta " + productoPedidoVentaListOrphanCheckProductoPedidoVenta + " in its productoPedidoVentaList field has a non-nullable producto field.");
            }
            ...
            Proveedor proveedorCedula = producto.getProveedorCedula();
            if (proveedorCedula != null) {
                proveedorCedula.getProductoList().remove(producto);
                proveedorCedula = em.merge(proveedorCedula);
            }
            em.remove(producto);
            em.getTransaction().commit();
