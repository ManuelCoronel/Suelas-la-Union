...
@NamedQueries({
    ...
    , @NamedQuery(name = "ProductoPedidoProveedor.findByTotal", query = "SELECT p FROM ProductoPedidoProveedor p WHERE p.total = :total")
...
public class ProductoPedidoProveedor implements Serializable {
    ...
    public String toString() {
        return "DTO.ProductoPedidoProveedor[ productoPedidoProveedorPK=" + productoPedidoProveedorPK + " ]";
    }
